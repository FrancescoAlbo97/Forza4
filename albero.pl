...
% i dovuti parametri
% alpha_beta(+Giocatore,-Mossa,+Depth,+Memory,-Value)
...
% alpha_beta(+Giocatore,+Memory,-Mossa,+Azioni,+Depth,-Value,+Alpha,+Beta
...
% i dovuti parametri
% minimax(+Giocatore,-Mossa,+Depth,+Memory,-Value)
...
% memorizzare, tra tutte le opzioni, qquella migliore, mentre Start è
% usata per inizializzarla propriamente.
% minimax(+Giocatore,+Memory,-Mossa,+Azioni,+Depth,-Value,+ValueAcc,+Start
% ,+MaxDepth)
